    ...
    <>
          ...
          <div>
            <div className="my-8">
              ...
              <p className="text-lg leading-8 text-gray-800 hidden md:block">
                "Welcome to Travel Trekker, your ultimate hub for extraordinary escapades! Discover diverse locales, plan effortlessly, and set out on an epic journey. Find curated accommodations, connect with fellow explorers, and create enduring memories. Your next adventure begins with Travel Trekker!"
              </p>

              <p className="mobpara md:hidden ">
                "Welcome to Travel Trekker, your premier source for unforgettable adventures! Discover a variety of destinations, plan effortlessly, and embark on the journey of a lifetime."
              </p>
            </div>
          </div>
      ...
      <section className="py-8 text-center px-6 md:px-12">
        ...
        <p className="text-lg leading-8 mb-8 text-gray-800">
          "Unveil travel wonders in our gallery, a snapshot of Travel Trekker's.
          adventures."
        </p>
        <ImagesGallery />
      </section>
